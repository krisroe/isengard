...
namespace IsengardClient.Backend
{
    public class IsengardMap
    {
        ...
        private void AddCelduinExpress(Room boatswain, Room breeDocks)
        {
            ...
            mithlondGraph.Rooms[boatswain] = new PointF(1, 4);
            mithlondGraph.Rooms[breeDocks] = new PointF(1, 3.5F);

            Room oBeneathBridge = AddRoom("Under Bridge", "Beneath the Bridge of the Celduin Express");
            mithlondGraph.Rooms[oBeneathBridge] = new PointF(-0.5F, 4.5F);
            ...
            e.MustOpen = true;
            mithlondGraph.Rooms[oBridge] = new PointF(-0.5F, 4.25F);
            ...
            mithlondGraph.Rooms[oUnderDeck] = new PointF(-1, 5.5F);
            ...
            mithlondGraph.Rooms[oPassengerLounge] = new PointF(-1, 5.75F);
            ...
            e.MustOpen = true;
            mithlondGraph.Rooms[oBoilerRoom] = new PointF(0, 5.5F);
            ...
            mithlondGraph.Rooms[oCelduinExpressNW] = new PointF(-2, 4);
            ...
            mithlondGraph.Rooms[oCelduinExpressMainDeckW] = new PointF(-2, 6);
            ...
            mithlondGraph.Rooms[oCelduinExpressMainDeckE] = new PointF(1, 6);
            ...
            mithlondGraph.Rooms[oCelduinExpressBow] = new PointF(-0.5F, 7);
        }
        ...
        private void AddUnderBree(Room oNorthBridge, Room oOuthouse, Room oSewerPipeExit)
        {
            ...
            underBreeGraph.Rooms[oNorthBridge] = new PointF(0, 0);
            underBreeGraph.Rooms[droolie] = new PointF(0, 0.5F);
            ...
            breeToImladrisGraph.Rooms[oCatchBasin] = new PointF(5, 7.5F);
        ...
        private void AddBreeToImladris(out Room oOuthouse, Room breeEastGateInside, Room breeEastGateOutside, out Room imladrisWestGateOutside, Room oCemetery)
        {
            ...
            breeToImladrisGraph.Rooms[breeEastGateInside] = new PointF(2, 4);
            breeToImladrisGraph.Rooms[oCemetery] = new PointF(2, 3);
            ...
            breeToImladrisGraph.Rooms[oGreatEastRoad1] = new PointF(4, 4);
        ...
        private void AddToFarmHouseAndUglies(Room oGreatEastRoad1, out Room oOuthouse, RoomGraph breeToImladrisGraph)
        {
            ...
            breeToImladrisGraph.Rooms[oRoadToFarm1] = new PointF(4, 5);
            ...
            breeToImladrisGraph.Rooms[oRoadToFarm2] = new PointF(4, 6);
            ...
            breeToImladrisGraph.Rooms[oWheatField] = new PointF(3, 6);
            ...
            breeToImladrisGraph.Rooms[oCornField] = new PointF(2, 5.75F);
            ...
            breeToImladrisGraph.Rooms[oLembasField] = new PointF(2, 6.25F);
            ...
            breeToImladrisGraph.Rooms[oRoadToFarm3] = new PointF(4, 7);
            ...
            breeToImladrisGraph.Rooms[oRoadToFarm4] = new PointF(4, 8);
            ...
            breeToImladrisGraph.Rooms[oRoadToFarm5] = new PointF(3, 8);
            ...
            breeToImladrisGraph.Rooms[oRoadToFarm6] = new PointF(2, 8);
            ...
            breeToImladrisGraph.Rooms[oGrainSilo] = new PointF(2, 9);
            ...
            breeToImladrisGraph.Rooms[oOuthouse] = new PointF(5, 8);
            ...
            breeToImladrisGraph.Rooms[oSwimmingPond] = new PointF(6, 8);
            ...
            breeToImladrisGraph.Rooms[oPond] = new PointF(6, 7.5F);
            ...
            breeToImladrisGraph.Rooms[oMuddyPath] = new PointF(7, 8);
            ...
            breeToImladrisGraph.Rooms[oFarmParlorManagerMulloyThreshold] = new PointF(2, 7);
            ...
            breeToImladrisGraph.Rooms[oManagerMulloy] = new PointF(2, 6.5F);
        ...
        private void AddEastOfImladris(Room oEastGateOfImladrisOutside, Room oEastGateOfImladrisInside, out Room westGateOfEsgaroth)
        {
            ...
            eastOfImladrisGraph.Rooms[oMountainTrail5] = new PointF(3, 0);
            ...
            eastOfImladrisGraph.Rooms[oMountainTrail6] = new PointF(3, -1);
            ...
            eastOfImladrisGraph.Rooms[oLarsMagnusGrunwald] = new PointF(3, -2);
        ...
        private void AddImladrisToTharbad(Room oImladrisSouthGateInside, out Room oTharbadGateOutside)
        {
            ...
            imladrisToTharbadGraph.Rooms[oMistyTrailForest] = new PointF(3, 5);
